...
public class MyGdxGame extends Game implements ApplicationListener {
	...
	public void parseEmails() {
		...
		try {
			...
			for (int i = 0; i < amountOfEmails; i++) {
				...
				Email e = new Email(i, lines.get(0), lines.get(1),
						lines.get(2), lines.get(3), lines.get(4), lines.get(5),
						lines.get(6));
				emailList.add(e);
				lines.clear();
			}
	...
	private void createTasks() {
		makeTask(1, "mailbox-color.png", "mailbox-gray.png",
				"Open your first email in the email app.");
		makeTask(2, "major-color.png", "major-gray.png", "Declare your major.");
		makeTask(1, "roommate-color.png", "roommate-gray.png",
				"Introduce yourself to your roommate.");
		makeTask(2, "register-color.png", "register-gray.png",
				"Register for five classes.");
		makeTask(1, "audit-color.png", "audit-gray.png",
				"Look at your degree audit.");
		makeTask(2, "drop-color.png", "drop-gray.png", "Drop a class.");
		makeTask(1, "writing-color.png", "writing-gray.png",
				"Sign up for a slot at the writing center.");
		makeTask(2, "shot-color.png", "shot-gray.png",
				"Sign up to get a flu shot.");
	}
